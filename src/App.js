...
const App = () => {
  ...
  useEffect(() => {
    alanBtn({
      key: 'cf61d2932473003d04d3cf2fb043277c2e956eca572e1d8b807a3e2338fdd0dc/stage',
      ...
      {!newsArticles.length ? (
        <div className={classes.footer}>
          <Typography variant="body1" component="h2">
            Created by
            <a className={classes.link} href="https://www.linkedin.com/in/jaketylersimon/"> Jake Simon</a>
          </Typography>
